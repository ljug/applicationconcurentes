...
/**
 * Créer n thread de type ClasseRunnable utilisation java exemple.App n argument
 * n (String représentant un entier) passé au main à la ligne de commande
 *
 * @author Pascal Fares
 */
public class App {
    ...
    public static void main(String... args) throws InterruptedException {
        ...
        for (int i = 0; i < nbThreadDemandes; i++) {
            tabThread[i] = new Thread(new Runnable() {
                @Override
                public void run() {
